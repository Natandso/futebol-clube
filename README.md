...
```bash
  git clone git@github.com:Natandso/futebol-clube.git
...
Neste projeto, foi composto por 4 fluxos essências:
1. Teams (Times)
...
## Database Utilizado
  ...
  - Recomendado: `Model com Sequelize` no conteúdo de `TypeScript: Tipagem Estática e Generics` é recomendada;
