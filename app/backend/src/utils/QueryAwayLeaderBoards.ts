...
SELECT 
    ...
    SUM(CASE
      WHEN matches.away_team_goals = matches.home_team_goals THEN 1 ELSE 0 END) AS totalDraws,
    SUM(CASE
      WHEN matches.away_team_goals < matches.home_team_goals THEN 1 ELSE 0 END) AS totalLosses,
